...
function createDraftForDuration(booking: AdminBookingDetailData): BookingDraft {
  return {
    ...
    parkingAvailable: "",
    accessToWaterAvailable: booking.location.accessToWaterAvailable,
    accessToElectricityAvailable: booking.location.accessToElectricityAvailable,
    accessibleParkingLocation: booking.location.accessibleParkingLocation,
