...
export function parseBookingDraft(value: unknown): ParsedDraftResult {
  ...
  return {
    draft: {
      ...
      accessToWaterAvailable: readBoolean(value.accessToWaterAvailable),
      accessToElectricityAvailable: readBoolean(value.accessToElectricityAvailable),
      accessibleParkingLocation: readBoolean(value.accessibleParkingLocation),
