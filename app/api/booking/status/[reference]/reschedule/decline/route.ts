import { declineRescheduleOffer } from "../../../../../../../lib/booking/reschedule-response";
...
export async function POST(_request: Request, context: RouteContext) {
  ...
  const result = await declineRescheduleOffer(decodeURIComponent(params.reference));
  ...
  return Response.json({
    success: true,
    data: result,
    message: "Suggested time declined.",
  });
}
